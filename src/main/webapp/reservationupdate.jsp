...
<body class="flex items-center justify-center min-h-screen">
    <div class="container mx-auto p-4 md:p-8">
        <div class="card p-6 md:p-10">
            <h1 class="text-2xl md:text-3xl font-bold text-center text-indigo-700 mb-8">Update Reservation</h1>
            ...
            <%-- Form to search for a reservation to update --%>
            ...
            <%-- Display the update form if a reservation object is found --%>
            <%
            ...
            <%
                    ...
                    // If ID was provided but no reservation found, show a message
            %>
